...
if __name__ == "__main__":
    ...
    if local_rank == 0:
        ...
        if total_step <= wanted_step:
            ...
            print("\033[1;33;44m[Warning] \033[0m"%(num_train, Unfreeze_batch_size, UnFreeze_Epoch, total_step))
            print("\033[1;33;44m[Warning] \033[0m"%(total_step, wanted_step, wanted_epoch))
